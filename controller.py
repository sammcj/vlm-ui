...
class Controller:
    ...
    def register_worker(self, worker_name: str, check_heart_beat: bool,
                        worker_status: dict):
        logger.info(f"Registering worker: {worker_name}, status: {worker_status}")
    ...
    def get_worker_status(self, worker_name: str):
        try:
            ...
            logger.error(f'Failed to parse worker status: {worker_name}, {e}')
        return None
    ...
    def list_models(self):
        ...
        for w_name, w_info in self.worker_info.items():
            logger.info(f"Worker {w_name} has models: {w_info.model_names}")
